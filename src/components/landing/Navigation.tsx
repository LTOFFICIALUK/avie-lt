    ...
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 w-full">
        ...
        <div className="relative z-10 w-full max-w-8xl mx-auto">
          <div className="flex items-center h-12 md:h-14 lg:h-16 px-3 sm:px-4 md:px-5 lg:px-7">
            ...
            {/* Logo - Clickable and responsive sizing */}
                ...
                <Link href="/" legacyBehavior>
                  <a className="block">
                    <Image
                      ...
                      height={24}
                      width={48}
                      className="cursor-pointer hover:opacity-90 transition-all duration-300 hover:scale-105 md:hidden"
                    />
                    <Image
                      src="/icons/avie-logo.png"
                      alt="AVIE Platform Logo"
                    ...
                    <Image
                      ...
                      height={39}
                      width={78}
                      className="cursor-pointer hover:opacity-90 transition-all duration-300 hover:scale-105 hidden lg:block"
                    />
                  </a>
                </Link>
              </div>
            ...
            {/* Desktop Navigation Links - Scaled down */}
            <div className="hidden md:flex items-center justify-center flex-1 space-x-1 lg:space-x-2 xl:space-x-3">
              {NAVIGATION_LINKS.map((link, index) => (
                <Link key={index} href={link.href} legacyBehavior>
                  <a
                    className="relative px-3 lg:px-4 xl:px-5 py-1.5 lg:py-2 text-gray-300 hover:text-white font-medium text-xs lg:text-sm transition-all duration-300 rounded-lg hover:bg-gradient-to-r hover:from-purple-600/10 hover:to-blue-600/10 border border-transparent hover:border-purple-500/20 group"
                  >
            ...
            {/* Desktop Auth Button - Scaled down */}
        ...
        {/* Enhanced Custom CSS for AuthSheet styling - Scaled down */}
        <style jsx global>{`
