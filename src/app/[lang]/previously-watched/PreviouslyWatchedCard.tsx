...
const PreviouslyWatchedCard: React.FC<PreviouslyWatchedCardProps> = ({ item, formatViewerCount }) => {
  ...
  return (
    <div className="w-60 bg-transparent border border-gray-700/50 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-200 hover:border-gray-600/50">
      {/* Thumbnail */}
